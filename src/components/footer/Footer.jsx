    ...
    <footer className="bg-white border-t border-gray-200 py-6 text-sm text-gray-600">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-2 flex justify-center items-center space-x-4">
          <a href="mailto:bktphcmdatabase2023@gmail.com" className="hover:text-primary">
        ...
        <div className="mt-3 flex justify-center space-x-4">
          ...
          <a href="#" className="text-gray-400 hover:text-primary"><i className="fab fa-facebook-f"></i>F</a>
          <a href="#" className="text-gray-400 hover:text-primary"><i className="fab fa-twitter"></i>T</a>
          <a href="#" className="text-gray-400 hover:text-primary"><i className="fab fa-instagram"></i>I</a>
          <a href="#" className="text-gray-400 hover:text-primary"><i className="fab fa-linkedin-in"></i>L</a>
        </div>
      </div>
    </footer>
  );
